...
import { IconArrowLeft, IconHelpCircle } from '../../../shared/components/Icons'
  ...
  return (
    <section className="grid min-h-[60vh] place-items-center text-center">
      <div className="ui-panel max-w-md p-8">
        {!isError ? (
          <div className="mx-auto grid h-14 w-14 place-items-center rounded-xl bg-blue-50 text-blue-600 ring-1 ring-blue-100">
          ...
          <div className="mx-auto grid h-14 w-14 place-items-center rounded-xl bg-red-50 text-red-600 ring-1 ring-red-200">
            <IconHelpCircle className="h-6 w-6" />
          </div>
        )}
        <h2 className="mt-4 text-xl font-bold text-slate-950">{isError ? 'Xác thực không thành công' : 'Đang chuyển hướng'}</h2>
